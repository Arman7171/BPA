...
const BranchInfo = ({branchWorkers, branchImports, getBranchProducts, prevMonthExports, prevMonthImports, branchExports, monthImports, exportPracent, monthExports, importPercent, getBranchWorkers, getBranchImports, getBranchExports}) => {
    const { id } = useParams();
